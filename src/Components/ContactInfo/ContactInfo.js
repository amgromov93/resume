...
export default function ContactInfo() {
  ...
  const titleTextClasses = styles.captionOne + ' ' + styles.contact__text;
  
  const contactItems = [
    {
      id: 1, 
      title: 'Email',
      description: <a className={styles.bodyTwo__bold} href="mailto:amgromov93@gmail.com">amgromov93@gmail.com</a>,
    ...
    },
    {
      id: 2, 
      title: 'Phone',
      description: <a className={styles.bodyTwo__bold} href="tel:+380737070737">+380737070737</a>,
    ...
    },
    {
      id: 3, 
      title: 'Website',
      description: <a className={styles.bodyTwo__bold} href="https://github.com/amgromov93">https://github.com/amgromov93</a>,
    ...
    },
    {
      id: 4, 
      title: 'Adress',
      description: <p className={styles.bodyTwo__bold}>Ukraine, Kyiv</p>,
